      ...
      <div className='flex items-stretch flex-wrap gap-4'>
        ...
        return (
          <button onClick={() => { 
            ...
            className={'p-4 px-5 rounded-lg purpleShadow duration-200 bg-purple-50 hover:bg-purple-100 text-center flex flex-col items-center gap-2 flex-1 '} key={moodIndex}>
